...
Public Class rptSalesPerBrand
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptSalesPerBrand.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSalesPerBrand
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSalesPerBrand = New rptSalesPerBrand()
        rpt.Site = Me.Site
        Return rpt
    End Function
