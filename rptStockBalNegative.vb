...
Public Class rptStockBalNegative
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptStockBalNegative.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptStockBalNegative.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockBalNegative
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockBalNegative = New rptStockBalNegative()
        rpt.Site = Me.Site
        Return rpt
    End Function
