...
Public Class rptSalesperCashier
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptSalesperCashier.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSalesperCashier
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSalesperCashier = New rptSalesperCashier()
        rpt.Site = Me.Site
        Return rpt
    End Function
