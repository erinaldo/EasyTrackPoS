...
Public Class rptSessionLedger
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptSessionLedger.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSessionLedger
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSessionLedger = New rptSessionLedger()
        rpt.Site = Me.Site
        Return rpt
    End Function
