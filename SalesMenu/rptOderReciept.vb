...
Public Class rptOderReciept
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptOderReciept.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOderReciept
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOderReciept = New rptOderReciept()
        rpt.Site = Me.Site
        Return rpt
    End Function
