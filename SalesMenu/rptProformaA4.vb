...
Public Class rptProformaA4
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptProformaA4.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptProformaA4
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProformaA4 = New rptProformaA4()
        rpt.Site = Me.Site
        Return rpt
    End Function
