...
Public Class rptSalesperItem
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptSalesperItem.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSalesperItem
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSalesperItem = New rptSalesperItem()
        rpt.Site = Me.Site
        Return rpt
    End Function
