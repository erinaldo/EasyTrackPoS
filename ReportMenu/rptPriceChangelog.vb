...
Public Class rptPriceChangelog
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptPriceChangelog.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPriceChangelog
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPriceChangelog = New rptPriceChangelog()
        rpt.Site = Me.Site
        Return rpt
    End Function
