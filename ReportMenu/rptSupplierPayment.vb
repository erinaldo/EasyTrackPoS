...
Public Class rptSupplierPayment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptSupplierPayment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSupplierPayment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSupplierPayment = New rptSupplierPayment()
        rpt.Site = Me.Site
        Return rpt
    End Function
