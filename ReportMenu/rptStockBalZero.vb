...
Public Class rptStockBalZero
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptStockBalZero.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockBalZero
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockBalZero = New rptStockBalZero()
        rpt.Site = Me.Site
        Return rpt
    End Function
