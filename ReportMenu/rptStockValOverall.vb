...
Public Class rptStockValOverall
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptStockValOverall.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockValOverall
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockValOverall = New rptStockValOverall()
        rpt.Site = Me.Site
        Return rpt
    End Function
