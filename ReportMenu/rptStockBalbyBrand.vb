...
Public Class rptStockBalbyBrand
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptStockBalbyBrand.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockBalbyBrand
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockBalbyBrand = New rptStockBalbyBrand()
        rpt.Site = Me.Site
        Return rpt
    End Function
