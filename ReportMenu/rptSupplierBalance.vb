...
Public Class rptSupplierBalance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptSupplierBalance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSupplierBalance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSupplierBalance = New rptSupplierBalance()
        rpt.Site = Me.Site
        Return rpt
    End Function
