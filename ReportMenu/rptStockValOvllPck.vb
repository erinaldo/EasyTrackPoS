...
Public Class rptStockValOvllPck
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptStockValOvllPck.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockValOvllPck
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockValOvllPck = New rptStockValOvllPck()
        rpt.Site = Me.Site
        Return rpt
    End Function
