...
Public Class rptCustomerSales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptCustomerSales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCustomerSales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCustomerSales = New rptCustomerSales()
        rpt.Site = Me.Site
        Return rpt
    End Function
