...
Public Class rptAdjustStock
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptAdjustStock.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAdjustStock
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAdjustStock = New rptAdjustStock()
        rpt.Site = Me.Site
        Return rpt
    End Function
