...
Public Class rptCustomerBalance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptCustomerBalance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCustomerBalance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCustomerBalance = New rptCustomerBalance()
        rpt.Site = Me.Site
        Return rpt
    End Function
