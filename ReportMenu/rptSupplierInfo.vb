...
Public Class rptSupplierInfo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptSupplierInfo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSupplierInfo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSupplierInfo = New rptSupplierInfo()
        rpt.Site = Me.Site
        Return rpt
    End Function
