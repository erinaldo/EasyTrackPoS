...
Public Class rptStockValPCatPck
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptStockValPCatPck.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockValPCatPck
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockValPCatPck = New rptStockValPCatPck()
        rpt.Site = Me.Site
        Return rpt
    End Function
