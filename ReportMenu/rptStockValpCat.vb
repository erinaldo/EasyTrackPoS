...
Public Class rptStockValpCat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptStockValpCat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockValpCat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockValpCat = New rptStockValpCat()
        rpt.Site = Me.Site
        Return rpt
    End Function
