...
Public Class rptStockBalbyPline
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptStockBalbyPline.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockBalbyPline
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockBalbyPline = New rptStockBalbyPline()
        rpt.Site = Me.Site
        Return rpt
    End Function
