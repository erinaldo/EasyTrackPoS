...
Public Class rptInventPerItem
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptInventPerItem.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInventPerItem
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInventPerItem = New rptInventPerItem()
        rpt.Site = Me.Site
        Return rpt
    End Function
