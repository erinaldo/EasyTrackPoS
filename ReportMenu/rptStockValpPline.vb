...
Public Class rptStockValpPline
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptStockValpPline.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockValpPline
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockValpPline = New rptStockValpPline()
        rpt.Site = Me.Site
        Return rpt
    End Function
