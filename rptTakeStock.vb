...
Public Class rptTakeStock
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptTakeStock.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTakeStock
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTakeStock = New rptTakeStock()
        rpt.Site = Me.Site
        Return rpt
    End Function
