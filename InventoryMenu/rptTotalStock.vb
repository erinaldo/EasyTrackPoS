...
Public Class rptTotalStock
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptTotalStock.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTotalStock
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTotalStock = New rptTotalStock()
        rpt.Site = Me.Site
        Return rpt
    End Function
