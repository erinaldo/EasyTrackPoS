...
Public Class rptTobeCollected
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptTobeCollected.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTobeCollected
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTobeCollected = New rptTobeCollected()
        rpt.Site = Me.Site
        Return rpt
    End Function
