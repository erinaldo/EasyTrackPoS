...
Public Class rptTobecollectedA4
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptTobecollectedA4.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTobecollectedA4
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTobecollectedA4 = New rptTobecollectedA4()
        rpt.Site = Me.Site
        Return rpt
    End Function
