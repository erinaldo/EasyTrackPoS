...
Public Class rptGoodsIssued
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptGoodsIssued.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGoodsIssued
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGoodsIssued = New rptGoodsIssued()
        rpt.Site = Me.Site
        Return rpt
    End Function
