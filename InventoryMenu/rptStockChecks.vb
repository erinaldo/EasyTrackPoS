...
Public Class rptStockChecks
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptStockChecks.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockChecks
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockChecks = New rptStockChecks()
        rpt.Site = Me.Site
        Return rpt
    End Function
