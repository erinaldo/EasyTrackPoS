...
Public Class rptSalesRecieptA4
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptSalesRecieptA4.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSalesRecieptA4
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSalesRecieptA4 = New rptSalesRecieptA4()
        rpt.Site = Me.Site
        Return rpt
    End Function
