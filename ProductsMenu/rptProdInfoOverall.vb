...
Public Class rptProdInfoOverall
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptProdInfoOverall.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptProdInfoOverall
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProdInfoOverall = New rptProdInfoOverall()
        rpt.Site = Me.Site
        Return rpt
    End Function
