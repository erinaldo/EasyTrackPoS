...
Public Class rptSalesRecieptA5
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptSalesRecieptA5.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSalesRecieptA5
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSalesRecieptA5 = New rptSalesRecieptA5()
        rpt.Site = Me.Site
        Return rpt
    End Function
