...
Public Class rptStockIssuedWHSE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptStockIssuedWHSE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockIssuedWHSE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockIssuedWHSE = New rptStockIssuedWHSE()
        rpt.Site = Me.Site
        Return rpt
    End Function
