...
Public Class rptStockPerCat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptStockPerCat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockPerCat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockPerCat = New rptStockPerCat()
        rpt.Site = Me.Site
        Return rpt
    End Function
