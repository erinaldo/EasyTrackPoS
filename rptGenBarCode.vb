...
Public Class rptGenBarCode
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptGenBarCode.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGenBarCode
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGenBarCode = New rptGenBarCode()
        rpt.Site = Me.Site
        Return rpt
    End Function
