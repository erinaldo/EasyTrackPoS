...
Partial Class InventoryReport
    ...
    Private Sub InitializeComponent()
        ...
        Me.cbReport.Items.AddRange(New Object() {"StockTaking Sheet", "Product List", "Products Per Category", "Products Per Productline", "Products by Colour", "Products by Size"})
        ...
        Me.Label1.Text = "Choose your report to view"
        '
        'InventoryReport
        '
