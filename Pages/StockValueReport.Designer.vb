...
Partial Class StockValueReport
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(StockValueReport))
        ...
        Me.Label1.Text = "Choose STOCK VALUE report to view"
        '
        'BunifuThinButton21
        '
        ...
        Me.cbReport.Items.AddRange(New Object() {"Stock Value per Category (Singles)", "Stock Value per Brand (Singles)", "Stock Value per Category (Pack)", "Stock Value per Brand (Pack)", "Stock Value Overall "})
