...
Public Class rptCustomerReciept
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptCustomerReciept.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCustomerReciept
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCustomerReciept = New rptCustomerReciept()
        rpt.Site = Me.Site
        Return rpt
    End Function
