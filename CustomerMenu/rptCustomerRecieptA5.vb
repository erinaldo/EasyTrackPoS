...
Public Class rptCustomerRecieptA5
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptCustomerRecieptA5.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptCustomerRecieptA5.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCustomerRecieptA5
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCustomerRecieptA5 = New rptCustomerRecieptA5()
        rpt.Site = Me.Site
        Return rpt
    End Function
