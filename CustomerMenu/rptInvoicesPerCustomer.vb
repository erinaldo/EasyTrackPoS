...
Public Class rptInvoicesPerCustomer
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptInvoicesPerCustomer.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptInvoicesPerCustomer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInvoicesPerCustomer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInvoicesPerCustomer = New rptInvoicesPerCustomer()
        rpt.Site = Me.Site
        Return rpt
    End Function
