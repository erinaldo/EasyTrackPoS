...
Public Class rptSalesperpaymode
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptSalesperpaymode.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSalesperpaymode
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSalesperpaymode = New rptSalesperpaymode()
        rpt.Site = Me.Site
        Return rpt
    End Function
