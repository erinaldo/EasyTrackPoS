...
Public Class rptSalesPerDate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptSalesPerDate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSalesPerDate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSalesPerDate = New rptSalesPerDate()
        rpt.Site = Me.Site
        Return rpt
    End Function
