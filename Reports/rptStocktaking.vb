...
Public Class rptStocktaking
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptStocktaking.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStocktaking
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStocktaking = New rptStocktaking()
        rpt.Site = Me.Site
        Return rpt
    End Function
