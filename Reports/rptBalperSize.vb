...
Public Class rptBalperSize
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptBalperSize.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBalperSize
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBalperSize = New rptBalperSize()
        rpt.Site = Me.Site
        Return rpt
    End Function
