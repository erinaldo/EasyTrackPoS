...
Public Class Sales_Reciept
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.Sales Reciept.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSales_Reciept
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Sales_Reciept = New Sales_Reciept()
        rpt.Site = Me.Site
        Return rpt
    End Function
