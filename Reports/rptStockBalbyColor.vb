...
Public Class rptStockBalbyColor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HardSoft_PoS.rptStockBalbyColor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptStockBalbyColor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptStockBalbyColor = New rptStockBalbyColor()
        rpt.Site = Me.Site
        Return rpt
    End Function
